...
public class setCalendar {
    ...
    public static String print_cal(int month, int year) {
    ...
    public static String print_cal() {
        Calendar calendar = Calendar.getInstance();
        String SB = print_cal(calendar.get(Calendar.MONTH), calendar.get(Calendar.YEAR));
        return SB;
    }
